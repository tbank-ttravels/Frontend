...
fun Add_Finance(
    ...
    val tabs = listOf("Расходы", "Переводы")
    ...
    Column {
        ...
        if (expenses.isEmpty()) {
            ...
            LazyColumn(
                ...
                categories.forEach { (category, categoryExpenses) ->
...
fun AddEditExpenseDialog(
    ...
    var selectedCategory by remember { mutableStateOf(expense?.category ?: "Прочее") }
    ...
    AlertDialog(
            ...
            Column(
                ...
                Box(
                    ...
                    DropdownMenu(
                        ...
                        TripViewModel.expenseCategories.forEach { categoryName ->
                            DropdownMenuItem(
                                text = {
                                    Row(
                                        verticalAlignment = Alignment.CenterVertically
        ...
        confirmButton = {
            Button(
                onClick = {
                    if (title.isNotBlank() && amount.isNotBlank() && amount.toDoubleOrNull() != null && selectedPayerId.isNotBlank()) {
...
fun getCategoryIcon(category: String): ImageVector {
    return when (category) {
        "Транспорт" -> Icons.Filled.DirectionsCar
        "Проживание" -> Icons.Filled.Hotel
        "Еда" -> Icons.Filled.Restaurant
        "Развлечения" -> Icons.Filled.LocalActivity
        "Покупки" -> Icons.Filled.ShoppingCart
...
fun getCategoryColor(category: String): Color {
    return when (category) {
        ...
        "Проживание" -> Color(0xFF9C27B0)
        "Еда" -> Color(0xFF4CAF50)
        "Развлечения" -> Color(0xFFFF9800)
        "Покупки" -> Color(0xFFE91E63)
